package com.resuadam.androidtime.view;
...
import com.resuadam.androidtime.core.DateTime;
import com.resuadam.androidtime.core.HttpFetcher;
import com.resuadam.androidtime.core.Observer;
...
public class MainActivity extends Activity implements Observer {
    ...
    public void setTimeInfo(DateTime data)
    {
        ...
        final TextView lblLng = this.findViewById( R.id.lblLng );
        final TextView lblLat = this.findViewById( R.id.lblLat );

        lblTime.setText( data.getDateTime() );
        lblTimeZoneInfo.setText( data.getTimeInfo() );
        lblGmtInfo.setText( data.getGmtInfo() );
        lblLng.setText( data.getLng() );
        lblLat.setText( data.getLat() );
    }
